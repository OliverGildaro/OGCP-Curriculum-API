...
public class EducationProfile : Profile
{
    ...
    private void UpdateEducationMapping()
    {
        CreateMap<UpdateEducationRequest, UpdateEducationFromQualifiedProfileCommand>()
            ...
            .Include<UpdateEducationToStudentProfileRequest, UpdateEducationFromStudentProfileCommand>()
        ...
        CreateMap<UpdateEducationToStudentProfileRequest, UpdateEducationFromStudentProfileCommand>();
