...
namespace OGCP.Curriculums.Writes.ProfileRepository.Migrations
{
    ...
    [Migration("20241223150050_initMig")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OGCP.Curriculums.Core.DomainModel.Images.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OGCP.Curriculums.Core.DomainModel.Images.Image", b =>
                {
                    b.HasOne("OGCP.Curriculum.API.domainmodel.Profile", null)
                        .WithOne("Image")
                        .HasForeignKey("OGCP.Curriculums.Core.DomainModel.Images.Image", "ProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
