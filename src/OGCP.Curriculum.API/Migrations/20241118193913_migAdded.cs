...
namespace OGCP.Curriculum.API.Migrations
{
    ...
    public partial class migAdded : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ResearchEducationStudentProfile",
                columns: table => new
                {
                    EducationsId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResearchEducationStudentProfile", x => new { x.EducationsId, x.StudentProfileId });
                    table.ForeignKey(
                        name: "FK_ResearchEducationStudentProfile_Education_EducationsId",
                        column: x => x.EducationsId,
                        principalTable: "Education",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ResearchEducationStudentProfile_Profile_StudentProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResearchEducationStudentProfile_StudentProfileId",
                table: "ResearchEducationStudentProfile",
                column: "StudentProfileId");
        }
